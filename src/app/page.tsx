...
const jsonLd = {
  ...
  jobTitle: 'Desenvolvedor full-stack e engenheiro de IA',
  description: 'Eu projeto, codifico e coloco no ar. Sites, sistemas, apps e automação com IA.',
  url: 'https://guilhermebertolo.com.br',
  image: 'https://guilhermebertolo.com.br/og?v=2',
